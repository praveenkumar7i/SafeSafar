...
public final class ItemVideoBinding implements ViewBinding {
  ...
  private ItemVideoBinding(@NonNull MaterialCardView rootView, @NonNull MaterialButton btnPlayVideo,
  ...
  public static ItemVideoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemVideoBinding((MaterialCardView) rootView, btnPlayVideo, imgThumbnail,
