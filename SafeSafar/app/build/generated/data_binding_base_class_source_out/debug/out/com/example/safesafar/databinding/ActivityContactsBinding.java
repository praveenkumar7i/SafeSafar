...
public final class ActivityContactsBinding implements ViewBinding {
  ...
  private ActivityContactsBinding(@NonNull LinearLayout rootView, @NonNull MaterialButton btnAdd,
  ...
  public static ActivityContactsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityContactsBinding((LinearLayout) rootView, btnAdd, etName, etPhone,
          rvContacts);
    }
